# Parameter adjustment for learners, UNSW-NB15 dataset after CAIA vector extraction
# FM & FIV, Oct 2018
print('---------------------------------------------------------------------------------------')
print('Parameter adjustment for learners, IDS-2017 dataset after CAIA vector extraction')
